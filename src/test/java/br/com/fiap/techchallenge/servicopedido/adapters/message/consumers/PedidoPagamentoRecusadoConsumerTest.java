...
@SpringBootTest
public class PedidoPagamentoRecusadoConsumerTest {

    @Autowired
    private ObjectMapper mapper;
    @Mock
    private AtualizaStatusPedidoInputPort atualizaStatusPedidoInputPort;
    private PedidoPagamentoRecusadoConsumer pedidoPagamentoRecusadoConsumer;
    private AutoCloseable openMocks;

    @BeforeEach
    void setup() {
        openMocks = MockitoAnnotations.openMocks(this);
        pedidoPagamentoRecusadoConsumer = new PedidoPagamentoRecusadoConsumer(atualizaStatusPedidoInputPort, mapper);
    }
    ...
    void deveAtualizarPedidoComStatusCancelado_QuandoReceberMensagemComFormatoCorreto() throws JsonProcessingException {
        ...
        //Act
        pedidoPagamentoRecusadoConsumer.receiveMessage(msgString);
    ...
    void deveLancarRuntimeException_QuandoNaoForPossivelSerializarMensagem() {
        //Arrange
        //Act
        assertThatThrownBy(() -> pedidoPagamentoRecusadoConsumer.receiveMessage("{\\}"))
